...
<p class="pagination">
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php if ($number === $current_page): ?>
			<a href="<?php echo HTML::chars($page->url($number)) ?>"><strong><?php echo $content ?></strong></a>
		<?php else: ?>
